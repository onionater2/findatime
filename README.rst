...
.. code-block:: bash
    ...
    heroku run python findatime/manage.py syncdb --noinput --settings=config.settings
    heroku run python findatime/manage.py migrate --settings=config.settings
    heroku run python findatime/manage.py collectstatic --settings=config.settings
